...
function getConfigApiClient(password: string, dbContext?: DatabaseContextType | null, saasContext?: SaaSContextType | null): ConfigApiClient {
  const encryptionConfig: ApiEncryptionConfig = {
    secretKey: password, // TODO: for entities other than Config we should take the masterKey from server config
