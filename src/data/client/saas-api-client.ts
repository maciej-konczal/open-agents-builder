...
export class SaasApiClient extends ApiClient {
    ...
    async get(saasToken: string, useCache:boolean = true): Promise<GetSaasResponse> { // under the hood the request passes emailHash from dbContext as soon as it gets it
