      ...
      <form onSubmit={handleCreateDatabase}>
        ...
        <div className="text-sm justify-between gap-4 mt-4">
          ...
          <Label htmlFor="acceptTerms">
            {t('I hereby accept Open Agents Builder ')}<Link target="_blank" className="underline hover:text-blue-500" href={termsUrl + (i18n.language === 'pl' ? '-pl' : '') }>{t('Terms of Service')}</Link>{t(' and ')}<Link target="_blank"  className="underline hover:text-blue-500" href={privacyUrl + (i18n.language === 'pl' ? '-pl' : '')}>{t('Privacy Policy')}</Link>.
          </Label>
