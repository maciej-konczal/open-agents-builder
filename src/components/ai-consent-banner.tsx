    ...
    <div className="bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 md:flex md:items-center md:justify-between shadow-lg" role="alert" aria-live="polite">
      <div className="mb-4 md:mb-0 md:mr-4 flex-grow">
        <p className="text-sm light:text-gray-900 dark:text-gray-300 dark:text-gray-300">
          {t('This service is provided by a third-party Platform User using our AI-powered tool. The AI chat (powered by OpenAI) may sometimes provide inaccurate or misleading information. For complete details regarding data processing, risks, and your rights—as set out in our')} <a href="/content/terms" className="text-primary hover:underline text-blue-400">{t('Terms')}</a>, <a href="/content/data-processing" className="text-primary hover:underline text-blue-400">{t('Data Processing Addendum (DPA)')}</a>, {t('and')} <a href="/content/privacy" className="text-primary hover:underline text-blue-400">{t('Privacy Policy')}</a>{t('— please click')} <a href="/content/disclaimer" className="text-primary hover:underline  text-blue-400"><strong>{t('Learn More')}...</strong></a>
        </p>
      </div>
