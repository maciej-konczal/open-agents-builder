...
export async function DELETE(request: Request, { params }: { params: { id: number }} ) {
    ...
    const prRepo = new ServerRecordRepository(requestContext.emailHash);
    ...
    if(!recordLocator){
        ...
        return Response.json(await genericDELETE(request, new ServerFolderRepository(requestContext.emailHash), { id: recordLocator}));
    }
}