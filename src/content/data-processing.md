...
This DPA supplements the agreement for the Services entered into by and between CTT and the Client (the “**Agreement**”) under the Terms of Service, which can be found at [https://openagentsbuilder.com](https://openagentsbuilder.com)/content/terms, and becomes effective on the same date as the Agreement. It will remain in effect for the duration of the Agreement. Any terms not defined in this DPA will carry the same meanings as specified in the Agreement.  
